<html lang="pt-br">
    <head>
        ...
        <title>Cadastro de notas dos da primeira unidade</title>
    </head>
   <body>
    <div class="container">  
  <form id="contact" action="../controller/controllerUnidade1.php" method="post">
    <h3>Cadastro de notas dos alunos da primeira unidade</h3>
