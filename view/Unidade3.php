<html lang="pt-br">
    <head>
        ...
        <title>Cadastro de notas dos da terceira unidade</title>
    </head>
   <body>
    <div class="container">  
  <form id="contact" action="../controller/controllerUnidade3.php" method="post">
    <h3>Cadastro de notas dos alunos da terceira unidade</h3>
